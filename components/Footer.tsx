...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--navy)', color: 'white', paddingTop: '4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '3rem', paddingBottom: '3rem' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.25rem' }}>
              <FooterLogo />
              <div>
                <div style={{ fontWeight: 800, fontSize: '1.125rem', lineHeight: 1 }}>PROUD</div>
                <div style={{ fontWeight: 500, fontSize: '0.65rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#93C5FD' }}>CONTRACTING</div>
              </div>
            </div>
          ...
          {/* Services */}
          <div>
            <h4 style={{ fontWeight: 700, fontSize: '0.9rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#93C5FD', marginBottom: '1.25rem' }}>Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 style={{ fontWeight: 700, fontSize: '0.9rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#93C5FD', marginBottom: '1.25rem' }}>Company</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} style={{ color: '#9CA3AF', fontSize: '0.9rem', textDecoration: 'none', transition: 'color 0.2s' }}
                    onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = 'white'}
                    onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.color = '#9CA3AF'}
                  >
                    {l.name}
          ...
          {/* Contact */}
          <div>
            <h4 style={{ fontWeight: 700, fontSize: '0.9rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#93C5FD', marginBottom: '1.25rem' }}>Contact</h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <a href="tel:7789193195" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: '#9CA3AF', textDecoration: 'none', fontSize: '0.9rem' }}>
                <span style={{ color: 'var(--blue-light)' }}>📞</span>
                778-919-3195
              </a>
              <a href="mailto:proudcontractinginc@gmail.com" style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', color: '#9CA3AF', textDecoration: 'none', fontSize: '0.9rem' }}>
                <span style={{ color: 'var(--blue-light)', flexShrink: 0 }}>✉️</span>
                proudcontractinginc@gmail.com
              </a>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', color: '#9CA3AF', fontSize: '0.9rem' }}>
            ...
            <div style={{ marginTop: '1.5rem' }}>
              <Link href="/contact" className="btn-primary" style={{ fontSize: '0.875rem', padding: '0.625rem 1.25rem' }}>
                Get a Free Quote
              </Link>
            </div>
          </div>
